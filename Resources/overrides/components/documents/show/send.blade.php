...
@php
    $nfseManagedSendFlow = ($document->type ?? '') === 'invoice'
        && (
            ($emailRoute ?? null) === 'nfse.modals.invoices.emails.create'
            || in_array(($textEmail ?? null), ['nfse::general.invoices.emit_now', 'nfse::general.invoices.reemit'], true)
        );
