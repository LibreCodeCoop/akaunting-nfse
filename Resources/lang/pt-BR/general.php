...
return [
    ...
    'vault_saved_continue'  => 'Configuração do Vault/OpenBao salva. Agora envie o certificado e finalize os demais dados fiscais.',
    'vault_required_before_certificate_and_settings' => 'Configure e valide o Vault/OpenBao (endereço, mount e autenticação) antes de enviar certificado ou salvar dados fiscais.',
    ...
    'settings' => [
        ...
        'vault_gate_ready_notice' => 'Vault/OpenBao pronto. Agora você pode enviar o certificado e concluir as configurações fiscais.',
        'vault_status_title' => 'Status atual do Vault/OpenBao',
        ...
        'vault_status_certificate_secret' => 'Segredo do certificado no Vault/OpenBao',
