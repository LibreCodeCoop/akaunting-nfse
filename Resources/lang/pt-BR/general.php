...
return [
    ...
    'invoices' => [
        ...
        'artifact_status_available' => 'Disponível no WebDAV',
        'artifact_status_not_found' => 'Não encontrado no WebDAV',
        'artifact_source' => 'Origem do caminho',
        'artifact_source_persisted' => 'Persistido no recibo',
        'artifact_source_template' => 'Resolvido via template',
        'artifact_source_unresolved' => 'Não resolvido',
        'artifact_path' => 'Caminho',
        'artifact_not_found' => 'Artefato não encontrado para esta NFS-e.',
        'artifact_invalid_type' => 'Tipo de artefato inválido.',
        ...
        'emit_modal_submitting' => 'Emitindo...',
        'emit_modal_title' => 'Preparar emissão da NFS-e',
        'emit_modal_description' => 'Descrição da NFS-e',
        'emit_modal_description_help' => 'Revise a descrição automática e ajuste o texto final que será enviado para a NFS-e.',
        'emit_modal_description_placeholder' => 'Descreva os serviços prestados nesta NFS-e.',
        'emit_modal_email_section' => 'Envio por e-mail',
        'emit_modal_send_email' => 'Enviar e-mail após a emissão',
        'emit_modal_send_email_hint' => 'Ative para personalizar e enviar a notificação agora.',
        'emit_modal_send_email_yes' => 'Sim, enviar e-mail',
        'emit_modal_send_email_no' => 'Não enviar e-mail',
        'emit_modal_email_to' => 'E-mail do destinatário',
        'emit_modal_email_subject' => 'Assunto do e-mail',
        'emit_modal_email_body' => 'Corpo do e-mail',
        'emit_modal_email_body_help' => 'As tags do template serão substituídas no envio.',
        'emit_modal_email_restore_default' => 'Restaurar template padrão',
        'emit_modal_email_attach_invoice_pdf' => 'Anexar Fatura (PDF)',
        'emit_modal_email_attach_danfse' => 'Anexar DANFSE (PDF)',
        'emit_modal_email_attach_xml' => 'Anexar XML',
        'emit_modal_email_save_default' => 'Salvar esta preferência de envio como padrão',
        ...
        'default_service_confirmation_required' => 'Existem itens sem serviço vinculado. Revise e confirme o uso do serviço padrão para emitir a NFS-e.',
        ...
        'reemit_modal_submitting' => 'Reemitindo...',
        'reemit_confirm' => 'Deseja reemitir esta NFS-e cancelada?',
        'reemit_modal_description' => 'Descrição da NFS-e reemitida',
        'reemit_modal_description_help' => 'Revise a descrição preenchida automaticamente com os dados da nota cancelada e ajuste se necessário.',
        'filter_all' => 'Todas',
        ...
        'view' => 'Ver',
        'view_nfse' => 'Ver NFS-e',
        'emit_success_modal_title' => 'NFS-e Emitida com Sucesso',
        'cancel_success_modal_title' => 'NFS-e Cancelada com Sucesso',
        'result_modal_error_title' => 'Erro',
        ...
        'tax_policy_notice' => 'Para emissão da NFS-e, os tributos federais são derivados dos impostos dos itens da fatura. Sem os tributos obrigatórios, a emissão é bloqueada.',
    ...
    'settings' => [
        ...
        'artifacts' => [
            ...
            'webdav_path_template_hint' => 'Defina a estrutura de pastas para armazenar os arquivos. Veja os placeholders disponíveis abaixo.',
            'webdav_filename_template' => 'Template do nome do arquivo',
            'webdav_filename_template_hint' => 'Use os mesmos placeholders do caminho. A extensão (.xml/.pdf) é adicionada automaticamente conforme o artefato.',
            ...
            'placeholders' => [
                ...
                '{year}'          => 'Ano de emissão (ex: 2026)',
                '{month}'         => 'Número do mês com zero (ex: 03)',
                '{day}'           => 'Dia do mês com zero (ex: 14)',
                '{month_name}'    => 'Nome do mês em português (ex: março)',
                '{nfse_number}'   => 'Número sequencial da NFS-e',
                '{chave_acesso}'  => 'Chave de acesso única da NFS-e',
                '{customer_name}' => 'Nome do cliente (tomador)',
            ],
        ],
    ],
];
