...
return [
    ...
    'vault_saved_continue'  => 'Vault/OpenBao configuration saved. You can now upload the certificate and complete fiscal settings.',
    'vault_required_before_certificate_and_settings' => 'Configure and validate Vault/OpenBao first (address, mount, and authentication) before uploading certificates or saving fiscal settings.',
    ...
    'nfse_secret_store_failed' => 'Could not read the certificate secret from Vault/OpenBao.',
    ...
    'readiness' => [
        ...
        'checks' => [
            ...
            'certificate_secret' => 'Certificate secret available in Vault/OpenBao',
        ],
    ],
    ...
    'settings' => [
        ...
        'vault_gate_ready_notice' => 'Vault/OpenBao is ready. You can now upload the certificate and complete fiscal settings.',
        'vault_status_title' => 'Current Vault/OpenBao status',
        ...
        'vault_status_certificate_secret' => 'Certificate secret in Vault/OpenBao',
