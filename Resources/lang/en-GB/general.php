...
return [
    ...
    'invoices' => [
        ...
        'artifact_status_available' => 'Available in WebDAV',
        'artifact_status_not_found' => 'Not found in WebDAV',
        'artifact_source' => 'Path source',
        'artifact_source_persisted' => 'Persisted in receipt',
        'artifact_source_template' => 'Resolved from template',
        'artifact_source_unresolved' => 'Unresolved',
        'artifact_path' => 'Path',
        'artifact_not_found' => 'Artifact not found for this NFS-e.',
        'artifact_invalid_type' => 'Invalid artifact type.',
        ...
        'emit_modal_send_email_hint' => 'Enable this to customize and send the notification now.',
        'emit_modal_send_email_yes' => 'Yes, send email',
        'emit_modal_send_email_no' => 'Do not send email',
        'emit_modal_email_to' => 'Recipient email',
        'emit_modal_email_subject' => 'Email subject',
        'emit_modal_email_body' => 'Email body',
        'emit_modal_email_body_help' => 'Template tags will be replaced when the message is sent.',
                'emit_modal_email_body_help' => 'Template tags will be replaced when the message is sent.',
                'emit_modal_email_restore_default' => 'Restore default template',
            'emit_modal_email_body_help' => 'Template tags will be replaced when the message is sent.',
            'emit_modal_email_restore_default' => 'Restore default template',
        'emit_modal_email_attach_invoice_pdf' => 'Attach Invoice (PDF)',
        ...
        'emit_modal_description_save_default_hint' => 'Enable this to save this description as the default for future NFS-e issuances.',
        ...
        'reemit_modal_submitting' => 'Reissuing...',
        ...
        'emit_success_modal_title' => 'NFS-e Issued Successfully',
        'cancel_success_modal_title' => 'NFS-e Cancelled Successfully',
        'result_modal_error_title' => 'Error',
    ...
    'settings' => [
        ...
        'artifacts' => [
            ...
            'webdav_path_template_hint' => 'Define the folder structure for storing files. See available placeholders below.',
            'webdav_filename_template' => 'Filename template',
            'webdav_filename_template_hint' => 'Use the same placeholders as path template. The extension (.xml/.pdf) is appended automatically per artifact type.',
            ...
            'placeholders' => [
                ...
                '{day}'           => 'Day of month zero-padded (e.g. 14)',
                '{month_name}'    => 'Month name in Portuguese (e.g. março)',
                '{nfse_number}'   => 'Sequential NFS-e number',
                '{chave_acesso}'  => 'Unique NFS-e access key',
