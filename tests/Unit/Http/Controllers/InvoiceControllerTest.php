...
namespace Modules\Nfse\Tests\Unit\Http\Controllers {
    ...
    final class InvoiceControllerTest extends TestCase
    {
        ...
        public function testEmitReturnsJsonErrorOnJsonExceptionWhenRequestIsAjax(): void
        {
            $invoice = InvoiceControllerIsolationState::makeInvoice(
                id: 781,
                amount: 200.00,
                items: [['name' => 'Servico Fail Json']],
                contactTaxNumber: '99887766000155',
            );
            $invoice->issued_at = '2026-01-15 10:00:00';
        ...
        public function testEmitDerivesPiscofinsValuesFromBaseAndAliquotsWhenSnapshotValuesDiffer(): void
        {
            ...
            ControllerIsolationState::$settings['nfse.federal_piscofins_tipo_retencao'] = '0';
            ...
            $invoice = InvoiceControllerIsolationState::makeInvoice(
                ...
                items: [[
                    'name' => 'Servico fiscal',
                    'item_taxes' => [
                        ['name' => 'PIS', 'amount' => 6.37],
                        ['name' => 'COFINS', 'amount' => 29.41],
                    ],
                ]],
                contactTaxNumber: '99887766000155',
            );
            ...
            $client = new class () implements NfseClientInterface {
                ...
                public function emit(DpsData $dps): ReceiptData
                {
                    ...
                    return new ReceiptData('NF-0782', 'CHAVE-782', '2026-01-15T10:00:00-03:00');
                }
            ...
            self::assertSame('0.67', $client->capturedDps?->federalPiscofinsAliquotaPis);
            self::assertSame('3.10', $client->capturedDps?->federalPiscofinsAliquotaCofins);
            self::assertSame('6.36', $client->capturedDps?->federalPiscofinsValorPis);
            self::assertSame('29.43', $client->capturedDps?->federalPiscofinsValorCofins);
        }
